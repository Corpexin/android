...
public class VisitasAdapter extends RecyclerView.Adapter<VisitasAdapter.ViewHolder> {
    ...
    private final ArrayList<Visita> mDatos;
    private OnItemClickListener onItemClickListener;

    // Constructor.
    public VisitasAdapter(ArrayList<Visita> datos) {
        mDatos = datos;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_tab1_item, parent, false);
    ...
    public void onBindViewHolder(VisitasAdapter.ViewHolder holder, int position) {
        ...
        Visita visita = mDatos.get(position);
        // Se escriben los mDatos en la vista.
        holder.lblDia.setText(visita.getDia());
        holder.lblResumen.setText(visita.getResumen());
    }
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, Visita visita, int position);
    }
}
