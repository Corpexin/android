package com.corpex.pr37contentproviders;
...
/**
 * Created by corpex, by the Grace of God on 18/02/2016.
 */
public class Adaptador extends SimpleCursorAdapter {
    ...
    static class ViewHolder{
        ...
        ViewHolder(View itemView){
            mLblNombre = (TextView) itemView.findViewById(R.id.lblNombre);
            mImgTipoLlamada = (ImageView) itemView.findViewById(R.id.imgTipoLlamada);
            mLblNumero = (TextView) itemView.findViewById(R.id.lblNumero);
            mLblFecha = (TextView) itemView.findViewById(R.id.lblFecha);
            mLblDuracion = (TextView) itemView.findViewById(R.id.lblDuracion);
        }
    }
}
