...
public class MainActivity extends Activity implements OnItemClickListener, OnClickListener, ServiceConnection{
    ...
    private void getVistas() {
        ...
        ArrayAdapter<Cancion> adaptador = new ArrayAdapter<Cancion>(this,android.R.layout.simple_list_item_activated_1, mCanciones);
    ...
    private void vincularServicio() {
        ...
        intent = new Intent(getApplicationContext(), MusicaOnlineService.class);
    ...
    public void onServiceConnected(ComponentName className, IBinder binder) {
        ...
        mServicio = ((MusicaOnlineService.LocalBinder) binder).getService();
        ...
        actualizarIU();
        // Si hay programada la reproducción de una canción, se reproduce y se
        // desprograma.
    ...
    private void reproducirCancion(int position) {
        if (mVinculado) {
            ...
            // Se programa la reproducción para cuando ya se haya establecido la
            // conexión tras la
            // vinculación.
    ...
    private void imgPlayOnClick() {
        if (mVinculado) {
            ...
            // Se programa la reproducción de la primera canción de la lista
            // para cuando ya se haya
    ...
    private ArrayList<Cancion> getListaCanciones() {
        ...
        canciones.add(new Cancion("Morning Mood (by Grieg)", "3:43", "https://www.youtube.com/audiolibrary_download?vid=036500ffbf472dcc"));
        canciones.add(new Cancion("Brahms Lullaby", "1:46", "https://www.youtube.com/audiolibrary_download?vid=9894a50b486c6136"));
        canciones.add(new Cancion("From Russia With Love", "2:26", "https://www.youtube.com/audiolibrary_download?vid=4e8d1a0fdb3bbe12"));
        canciones.add(new Cancion("Les Toreadors from Carmen (by Bizet)", "2:21", "https://www.youtube.com/audiolibrary_download?vid=fafb35a907cd6e73"));
        canciones.add(new Cancion("Funeral March (by Chopin)", "9:25", "https://www.youtube.com/audiolibrary_download?vid=4a7d058f20d31cc4"));
        return canciones;
    }
}
