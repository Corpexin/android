package com.corpex.pr38capturaaudio;
...
public class MainActivity extends Activity implements OnTouchListener,OnPreparedListener, OnCompletionListener, OnInfoListener {
    ...
    private void prepararGrabacion() {
        ...
        String pathGrabacion = Environment.getExternalStorageDirectory().getAbsolutePath() + "/audio.3gp";
    ...
    private void cambiarEstadoGrabacion(boolean estaGrabando) {
        ...
        btnRec.setImageResource(estaGrabando ? R.drawable.ic_micro_recording7
                : R.drawable.ic_micro);
    }
